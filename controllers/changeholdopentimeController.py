...
class ChangeholdopentimeController:

    def __init__(self, model: Model, view: View, timer: TimeCounter) -> None:
        self.model = model
        self.view = view
        self.timer = timer
        self.frame = self.view.frames["changeholdopentime"]
        self.bind_buttons()
        self.update_view()
    ...
    def confirm_button_action(self):
        self.timer.clicked()
        self.model.settingmodel.change_setting("hold_open_time",self.frame.hold_open_time_slider.get())
        self.view.switchFrame("settings")
    
    def enter_error_menu(self):
        self.timer.increaseAlarm()
        self.view.switchFrame("errormenu")
        self.model.errormessagemodel.lastFrame ="changeholdopentime"

    def update_view(self):
        self.frame.hold_open_time_slider.set(self.model.settingmodel.get_setting("hold_open_time"))
